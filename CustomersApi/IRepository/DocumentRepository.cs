...
namespace CustomersApi.IRepository
{
    public class DocumentRepository : BaseDataAccess, IDocumentRepository
    {
        ...
        public async Task<Document> GetDocumentsByCustomer(int customerId)
        {
            ...
            using (var reader = await Task.Run(() => ExecuteReader("GetDocumentsByCustomerID", CommandType.StoredProcedure, new SqlParameter("@CustomerId", customerId))))
            {
        ...
        {
            await Task.Run(() => ExecuteNonQuery("InsertCustomerDocument", CommandType.StoredProcedure,
        ...
        {
            await Task.Run(() => ExecuteNonQuery("UpdateCustomerDocument", CommandType.StoredProcedure,
        ...
        public async Task<int> GetDocumentId(int customerId, int docType)
        {
            ...
            using (var command = _connection.CreateCommand())
            {
                ...
                command.CommandText = "GetDocumentIdByCustomerAndType"; // Your stored procedure name
